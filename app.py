...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>💡 <strong>Tip:</strong> Smart email validation with mail server detection</p>
...
def validate_api():
    """API endpoint for email validation using the working basic method"""
    try:
        ...
        # Step 4: Use the working basic SMTP validation
